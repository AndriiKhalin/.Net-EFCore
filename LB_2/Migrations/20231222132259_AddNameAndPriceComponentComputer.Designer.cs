...
namespace LB_2.Migrations
{
    ...
    [Migration("20231222132259_AddNameAndPriceComponentComputer")]
    partial class AddNameAndPriceComponentComputer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LB_2.Models.Data.ComponentComputer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LB_2.Models.Data.Computer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LB_2.Models.Data.HardDrive", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LB_2.Models.Data.MotherBoard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LB_2.Models.Data.Processor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LB_2.Models.Data.Ram", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LB_2.Models.Data.Unit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LB_2.Models.Data.VideoCard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LB_2.Models.Data.ComponentComputer", b =>
                {
                    b.HasOne("LB_2.Models.Data.HardDrive", "HardDrive")
                        .WithMany("ComponentComputers")
                        .HasForeignKey("HardDriveId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("LB_2.Models.Data.MotherBoard", "MotherBoard")
                        .WithMany("ComponentComputers")
                        .HasForeignKey("MotherBoardId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("LB_2.Models.Data.Processor", "Processor")
                        .WithMany("ComponentComputers")
                        .HasForeignKey("ProcessorId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("LB_2.Models.Data.Ram", "Ram")
                        .WithMany("ComponentComputers")
                        .HasForeignKey("RamId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("LB_2.Models.Data.Unit", "Unit")
                        .WithMany("ComponentComputers")
                        .HasForeignKey("UnitId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("LB_2.Models.Data.VideoCard", "VideoCard")
                        .WithMany("ComponentComputers")
            ...
            modelBuilder.Entity("LB_2.Models.Data.Computer", b =>
                {
                    b.HasOne("LB_2.Models.Data.ComponentComputer", "ComponentComputer")
                        .WithMany("Computers")
